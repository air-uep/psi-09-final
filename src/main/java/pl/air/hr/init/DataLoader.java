...
public class DataLoader {
	...
	public void insertData() {
		...
		/* stanowiska */
		Position manager =     createPostion("Kierownik");
		Position expert =     createPostion("Ekspert");
		Position specialist = createPostion("Specjalista");
	...
	private Position createPostion(String name) {
